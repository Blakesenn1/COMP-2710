/**
* File Name: project3_Senn_abs0113.cpp
...
*
* I watched a video on youtube by Portfolio Courses
* to understand instream and ifstream statements.
*
*/
#include <iostream>
#include <fstream>
...
int main() {
    ...
    cout << endl << "*** Welcome to Blake's sorting program ***\n";
